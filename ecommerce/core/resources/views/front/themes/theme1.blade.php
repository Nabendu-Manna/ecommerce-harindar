                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        <a href="{{$banner_first['firsturl1']}}" class="genius-banner">
                            ...
                            <img src="{{ asset('assets/new/Section 2/img13.jpg') }}" alt=""  style="height: 15rem; width: 100%;">
                        </a>
                    </div>
                    <div class="col-md-4">
                        <a href="{{$banner_first['firsturl2']}}" class="genius-banner">
                            {{-- <img src="{{ asset('assets/images/'.$banner_first['img2']) }}" alt=""> --}}
                            <img src="{{ asset('assets/new/Section 2/img14.jpg') }}" alt=""  style="height: 15rem; width: 100%;">
                        </a>
                    </div>
                    <div class="col-md-4">
                        <a href="{{$banner_first['firsturl3']}}" class="genius-banner">
                            {{-- <img src="{{ asset('assets/images/'.$banner_first['img3']) }}" alt=""> --}}
                            <img src="{{ asset('assets/new/Section 2/img15.jpg') }}" alt="" style="height: 15rem; width: 100%;">
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        <a href="{{$banner_secend['url1']}}" class="genius-banner">
                            ...
                            <img src="{{ asset('assets/new/Section 3/img4.jpg') }}" alt=""  style="height: 15rem; width: 100%;">
                        </a>
                    </div>
                    <div class="col-md-4">
                        <a href="{{$banner_secend['url2']}}" class="genius-banner">
                            {{-- <img class="lazy" data-src="{{ asset('assets/images/'.$banner_secend['img2']) }}" alt=""> --}}
                            <img src="{{ asset('assets/new/Section 3/img11.jpg') }}" alt=""  style="height: 15rem; width: 100%;">
                        </a>
                    </div>
                    <div class="col-md-4">
                        <a href="{{$banner_secend['url3']}}" class="genius-banner">
                            {{-- <img class="lazy" data-src="{{ asset('assets/images/'.$banner_secend['img3']) }}" alt=""> --}}
                            <img src="{{ asset('assets/new/Section 3/img19.jpg') }}" alt=""  style="height: 15rem; width: 100%;">
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        <a href="{{$banner_third['url1']}}" class="genius-banner">
                            ...
                            <img class="lazy" data-src="{{ asset('assets/new/Section 4/img1.jpg') }}" alt="" style="height: 15rem; width: 100%;">
                        </a>
                    </div>
                    <div class="col-md-6">
                        <a href="{{$banner_third['url2']}}" class="genius-banner">
                            {{-- <img class="lazy" data-src="{{ asset('assets/images/'.$banner_third['img2']) }}" alt=""> --}}
                            <img class="lazy" data-src="{{ asset('assets/new/Section 4/img13.jpg') }}" alt="" style="height: 15rem; width: 100%;">
                        </a>
                    </div>
                </div>
            </div>
