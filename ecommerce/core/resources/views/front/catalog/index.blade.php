        ...
        <div class="row g-3">
          ...
          <div class="col-lg-3 order-lg-1">
            ...
            <aside class="sidebar sidebar-offcanvas position-left"><span class="sidebar-close"><i class="icon-x"></i></span>
              ...
              <section class="widget widget-categories card rounded p-4">
                <h3 class="widget-title">Age</h3>
                <div class="custom-control custom-checkbox">
                  <input class="custom-control-input brand-select" type="checkbox" value="" id="a1">
                  <label class="custom-control-label" for="a1">0-8 Months</label>
                </div>
                <div class="custom-control custom-checkbox">
                  <input class="custom-control-input brand-select" type="checkbox" value="" id="a2">
                  <label class="custom-control-label" for="a2">1-2 Years</label>
                </div>
                <div class="custom-control custom-checkbox">
                  <input class="custom-control-input brand-select" type="checkbox" value="" id="a2">
                  <label class="custom-control-label" for="a2">2-3 Years</label>
                </div>
                <div class="custom-control custom-checkbox">
                  <input class="custom-control-input brand-select" type="checkbox" value="" id="a2">
                  <label class="custom-control-label" for="a2">2-3 Years</label>
                ...
                <div class="custom-control custom-checkbox">
                  <input class="custom-control-input brand-select" type="checkbox" value="" id="a2">
                  <label class="custom-control-label" for="a2">3-4 Years</label>
                </div>
                <div class="custom-control custom-checkbox">
                  <input class="custom-control-input brand-select" type="checkbox" value="" id="a2">
                  <label class="custom-control-label" for="a2">4-5 Years</label>
                </div>
                <div class="custom-control custom-checkbox">
                  <input class="custom-control-input brand-select" type="checkbox" value="" id="a2">
                  <label class="custom-control-label" for="a2">5-6 Years</label>
                </div>
                <div class="custom-control custom-checkbox">
                  <input class="custom-control-input brand-select" type="checkbox" value="" id="a2">
                  <label class="custom-control-label" for="a2">6-7 Years</label>
                </div>
                <div class="custom-control custom-checkbox">
                  <input class="custom-control-input brand-select" type="checkbox" value="" id="a2">
                  <label class="custom-control-label" for="a2">7-8 Years</label>
                </div>
                <div class="custom-control custom-checkbox">
                  <input class="custom-control-input brand-select" type="checkbox" value="" id="a2">
                  <label class="custom-control-label" for="a2">8-9 Years</label>
                </div>
                <div class="custom-control custom-checkbox">
                  <input class="custom-control-input brand-select" type="checkbox" value="" id="a2">
                  <label class="custom-control-label" for="a2">9-10 Years</label>
                </div>
                <div class="custom-control custom-checkbox">
                  <input class="custom-control-input brand-select" type="checkbox" value="" id="a2">
                  <label class="custom-control-label" for="a2">10-11 Years</label>
                </div>
                <div class="custom-control custom-checkbox">
                  <input class="custom-control-input brand-select" type="checkbox" value="" id="a2">
                  <label class="custom-control-label" for="a2">11-12 Years</label>
                </div>
                <div class="custom-control custom-checkbox">
                  <input class="custom-control-input brand-select" type="checkbox" value="" id="a2">
                  <label class="custom-control-label" for="a2">12-13 Years</label>
                </div>
                <div class="custom-control custom-checkbox">
                  <input class="custom-control-input brand-select" type="checkbox" value="" id="a2">
                  <label class="custom-control-label" for="a2">13-14 Years</label>
                </div>
                <div class="custom-control custom-checkbox">
                  <input class="custom-control-input brand-select" type="checkbox" value="" id="a2">
                  <label class="custom-control-label" for="a2">14-15 Years</label>
                </div>
                <div class="custom-control custom-checkbox">
                  <input class="custom-control-input brand-select" type="checkbox" value="" id="a2">
                  <label class="custom-control-label" for="a2">15-16 Years</label>
                </div>
                <div class="custom-control custom-checkbox">
                  <input class="custom-control-input brand-select" type="checkbox" value="" id="a2">
                  <label class="custom-control-label" for="a2">16-17 Years</label>
                </div>
                <div class="custom-control custom-checkbox">
                  <input class="custom-control-input brand-select" type="checkbox" value="" id="a2">
                  <label class="custom-control-label" for="a2">17-18 Years</label>
                </div>
              </section>
              ...
              <section class="widget widget-categories card rounded p-4">
                ...
                <div class="custom-control custom-checkbox">
                    <input class="custom-control-input option" type="checkbox" value="" id="">
                    <label class="custom-control-label" for="">Male</label>
                </div>
                <div class="custom-control custom-checkbox">
                    <input class="custom-control-input option" type="checkbox" value="" id="">
                    <label class="custom-control-label" for="">Women</label>
                </div>
                <div class="custom-control custom-checkbox">
                    <input class="custom-control-input option" type="checkbox" value="" id="">
                    <label class="custom-control-label" for="">Kids</label>
                </div>
              </section>
